...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const l="feedback-form-state",a=document.querySelector(".feedback-form");let s={};const n=e=>{s[e.target.name]=e.target.value;const t=JSON.stringify(s);localStorage.setItem(l,t)},r=localStorage.getItem(l),m=JSON.parse(r),u=()=>{a.elements.email.value=null!==m?m.email:"",a.elements.message.value=null!==m?m.message:""};a.elements.email.value=null!==m?m.email:"",a.elements.message.value=null!==m?m.message:"";const o=e=>{e.preventDefault();const{elements:{email:t,message:n}}=e.currentTarget;if(""===t.value||""===n.value)return;const r={email:a.elements.email.value,message:a.elements.message.value};console.log(r),e.currentTarget.reset(),localStorage.removeItem(l),s={}};a.addEventListener("input",(0,e.default)(n,500)),a.addEventListener("submit",o);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.327c15ff.js.map