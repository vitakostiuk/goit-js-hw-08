...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o="feedback-form-state",r=document.querySelector(".feedback-form");let a={};const n=e=>{a={...a,[e.target.name]:e.target.value};const t=JSON.stringify(a);localStorage.setItem(o,t),console.log(t)};r.addEventListener("input",(0,e.default)(n,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.33fe277b.js.map